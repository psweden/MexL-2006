...
public class HelpInfo extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        imageGraphics.drawString("Direct ver 1.0", width/2, 30, Graphics.TOP | Graphics.HCENTER);

        imageGraphics.setColor(0xffff00);

        imageGraphics.drawString("Support", width/2, 50, Graphics.TOP | Graphics.HCENTER);

        imageGraphics.drawString("Contact Us", width/2, 65, Graphics.TOP | Graphics.HCENTER);
